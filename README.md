...
**Auto-Probe** is an automated framework for constructing LVLM hallucination evaluation datasets through model behavior-based sample construction and the novel AttriBait evaluation paradigm.

## Overview

The Auto-Probe framework consists of five core stages that enable end-to-end automated construction of hallucination evaluation datasets:

1. **Hallucination Induction** - Strategically elicit hallucination behaviors from LVLMs
2. **Object Extraction** - Extract and clean candidate objects from model descriptions  
3. **Visual Verification** - Distinguish existing from hallucinated objects using dual-threshold classification
...
This documentation presents complete pseudocode algorithms for all framework components. The pseudocode provides full algorithmic transparency for research reproducibility while protecting core implementation details during the review process. Complete source code will be released upon paper acceptance.
